function [summarymat, shadingmat, depthrange] = ussummary(depthstart, depthend, nsim, agedepmat, interpinterval, inputfile, writedir, bootpc, xfactor, depthcombine, savebigmat, proxy, SaveName)
