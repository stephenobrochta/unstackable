function [summarymat, shadingmat, depthrange, sarsummarymat, sarshadingmat] = ussummary(depthstart, depthend, nsim, agedepmat, interpinterval, inputfile, writedir, bootpc, xfactor, depthcombine, sar, savebigmat)
